...
<head>
   ...
   <title>Tìm Kiếm | Bookstories</title>
...
<div class="heading">
   <h3 style="color: white;">Tìm Kiếm</h3>
   <p style="color: white;"> Bạn Sẽ Tìm Thấy Những Gì Bạn Muốn Ở Đây! </p>
</div>
...
<section class="products" style="padding-top: 0;">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="price"><?php echo $fetch_product['price']; ?> VNĐ</div>
